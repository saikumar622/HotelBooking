       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              ...
              <br>
              <p>Our hotel booking website revolutionizes the way travelers find and book accommodations. With a user-friendly interface and a vast selection of hotels worldwide, we provide an unparalleled booking experience.</p>
              <br>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address :Patna<br>
              Mail :AmbicaHotelbooking@gmail.com <br>
            </div>
